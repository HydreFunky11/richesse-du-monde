...
const GAMES: GameTheme[] = [
  ...
  },
  {
    ...
    description: 'Chaque manche, recevez une note secrète de 0 à 10 inconnue de vous. Posez une question aux autres joueurs qui y répondent selon votre note. Devinez avec précision en 5 manches pour triompher !',
    route: '/note',
    fontClass: 'font-display font-black tracking-wide',
    cardTheme: 'bg-gradient-to-b from-amber-950/80 via-slate-950 to-purple-950/40',
    borderTheme: 'border-amber-500/50 hover:border-yellow-300 hover:shadow-amber-900/60',
    titleGradient: 'from-amber-300 via-yellow-400 to-amber-500',
    badge: 'PARTY GAME & DÉDUCTION 🔟',
    badgeStyle: 'bg-amber-950 text-amber-300 border-amber-500/50',
    players: '1 à 8 Joueurs (Solo Bots ou En Ligne)',
  },
  {
    emoji: '🔫',
    ...
    badge: 'FPS 3D CUBIQUE 💥',
    badgeStyle: 'bg-gradient-to-r from-red-950 to-amber-900 text-amber-300 border-amber-500/50',
  ...
  },
  {
    ...
    badge: 'ROGUELITE ⛏️',
    badgeStyle: 'bg-gradient-to-r from-emerald-950 to-green-900 text-emerald-300 border-emerald-500/50',
  ...
  },
  {
    ...
    badge: 'MOBA EN LIGNE 🏆',
    badgeStyle: 'bg-gradient-to-r from-amber-950 to-orange-900 text-amber-300 border-amber-500/50',
  ...
  },
  {
    ...
    badge: 'RTS FUTURISTE ⚡',
    badgeStyle: 'bg-gradient-to-r from-cyan-950 to-blue-900 text-cyan-300 border-cyan-500/50',
  ...
  },
  {
    ...
    badge: '1V1 SPAM 🤼',
    badgeStyle: 'bg-gradient-to-r from-red-900 to-amber-800 text-amber-200 border-amber-500/50',
  ...
  },
  {
    ...
    badge: 'SOLO IDLE ♾️',
    badgeStyle: 'bg-gradient-to-r from-purple-900 to-amber-800 text-amber-200 border-amber-500/50',
  ...
  },
  {
    ...
    badge: 'TEMPS RÉEL ⚡',
    badgeStyle: 'bg-purple-950 text-purple-300 border-purple-500/50',
  ...
  },
  {
    emoji: '🎲',
    title: 'Chaos Board',
    subtitle: 'Roguelite & Lois du Chaos par l\'IA',
    description: 'Inspiré de Magic The Noah : quand un joueur meurt, il décrète une NOUVELLE RÈGLE rédigée par l\'IA qui s\'accumule partie après partie !',
    route: '/chaos',
    fontClass: 'font-comic tracking-wide text-2xl',
    cardTheme: 'bg-gradient-to-b from-purple-950/40 via-slate-950 to-red-950/40',
    borderTheme: 'border-purple-500/40 hover:border-purple-300 hover:shadow-purple-900/40',
    titleGradient: 'from-fuchsia-400 via-purple-300 to-amber-400',
    badge: 'IA OPENROUTER 😈',
    badgeStyle: 'bg-purple-950 text-fuchsia-300 border-purple-500/50',
