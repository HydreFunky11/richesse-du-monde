...
class SoundEffectsManager {
  ...
  // 13. RTS Construction Complete Chime
  public constructionComplete() {
    const ctx = this.getContext();
    if (!ctx) return;
