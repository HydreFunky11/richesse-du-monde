...
class RacingEngine {
    ...
    gameLoop = null;
    splinePoints = [];
    cumulativeLengths = []; // cumulative arc length at each spline point
    lastTick = 0;
    ...
    selectVehicle(socketId, vehicle) {
    ...
    startRace() {
        if (this.state.status !== 'VEHICLE_SELECT')
            return;
    ...
    setInput(socketId, throttle, steer) {
...
exports.RacingEngine = RacingEngine;
