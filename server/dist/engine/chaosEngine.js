...
class ChaosEngine {
    ...
    async submitNewRule(socketId, ruleText, onStepUpdate) {
        ...
        try {
            ...
            const parsedRule = await (0, chaosAi_1.interpretChaosRule)(ruleText, author, this.state.roundNumber, this.state, (aiLog) => {
