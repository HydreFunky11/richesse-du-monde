...
exports.CASES_DATABASE = exports.SKINS_DATABASE = void 0;
exports.getSkinDefinition = getSkinDefinition;
exports.generateSkinInstance = generateSkinInstance;
exports.rollCaseDrop = rollCaseDrop;
exports.SKINS_DATABASE = [
...
function getSkinDefinition(id) {
    const found = exports.SKINS_DATABASE.find(s => s.id === id);
    if (!found) {
        return exports.SKINS_DATABASE[0]; // fallback sand dune
    }
    return found;
}
// Tirer un float réaliste et un coefficient d'usure
function generateSkinInstance(skinId, sourceName) {
