import { DiscretosGameState, DiscretosPlayer, DiscretosTheme } from '../types/discretos';

const THEMES: DiscretosTheme[] = [
  {
...
export class DiscretosEngine {
  ...
  private selectedTheme: DiscretosTheme | null = null;
