...
export const CHAOS_CORE_MANUAL = `
══════════════════════════════════════════════════════════════════════════════
...
export const CHAOS_INTENT_DICTIONARY = `
══════════════════════════════════════════════════════════════════════════════
...
export const CHAOS_FEW_SHOT_ENCYCLOPEDIA = `
══════════════════════════════════════════════════════════════════════════════
...
export const CHAOS_COMBOS_AND_STATUS_THEORY = `
══════════════════════════════════════════════════════════════════════════════
...
export const CHAOS_EXTRA_FEW_SHOTS = `
--- EXEMPLE DÉCRET #69 ---
...
export const CHAOS_TACTICAL_MANEUVERS = `
══════════════════════════════════════════════════════════════════════════════
...
export function buildChaosDynamicSystemPrompt(
  currentCells: Array<{ id: string; x: number; y: number; name: string; icon: string }>,
  players: Array<{ username: string; hp: number; maxHp: number; atk: number }>,
  authorName: string,
  userRuleText: string
): string {
  ...
  return `${CHAOS_CORE_MANUAL}

${CHAOS_INTENT_DICTIONARY}

${CHAOS_BESTIARY}

${CHAOS_FEW_SHOT_ENCYCLOPEDIA}

${CHAOS_COMBOS_AND_STATUS_THEORY}

${CHAOS_EXTRA_FEW_SHOTS}

${CHAOS_TACTICAL_MANEUVERS}
